...
<head>
    ...
    <title>Torneos eSports Teletón</title>
            ...
            <div class="container" style="display: flex; justify-content:center">
                ...
                <div class="signup-content" style="display: flex; justify-content:center;">
                    ...
                    <div class="signup-form">
                        <img src="forms/images/Banner-formulario-gran-turismo-7.png" alt="">


                        <form method="POST" class="register-form" id="register-form">
                            <br>
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">Nombre completo</p>
                            ...
                            <br>
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">RUT</p>
                                <p style="color:red;font-family: Poppins;">*</p>
                            </div>
                            <div class="form-group">
                            ...
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">Fecha de nacimiento</p>
                                <p style="color:red;font-family: Poppins;">*</p>
                            </div>
                            <div class="form-group">
                            ...
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">Correo electrónico</p>
                                <p style="color:red;font-family: Poppins;">*</p>
                            </div>
                            <div class="form-group">
                                <label for="email">
                            ...
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">Teléfono</p>
                                <p style="color:red;font-family: Poppins;">*</p>
                            </div>
                            <div class="form-group">
                            ...
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">Usuario de Discord</p>
                                <p style="color:red;font-family: Poppins;">*</p>
                            </div>
                            <div class="form-group">
                                <label for="Discord">
                            ...
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">Plataforma</p>
                                <p style="color:red;font-family: Poppins;">*</p>
                            </div>
                            <div class="form-group">
                            ...
                            <div style="display: flex;">
                                <p style="color:black;font-family: Poppins;">PSN ID</p>
                                <p style="color:red;font-family: Poppins;">*</p>
                            </div>
                            <div class="form-group">
                                <label for="psnid">
                                ...
                                <input type="text" name="psnid" id="psnid" required />
                            </div>
                            <br>
                        ...
                        <?php 
                            ...
                            include('database/get_granturismo7.php');
